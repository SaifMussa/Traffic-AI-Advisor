...
st.markdown(f"""
    ...
    /* القائمة الجانبية (تم تحويلها للأحمر) */
    ...
    /* === إصلاح القائمة المنسدلة (Selectbox Fix) === */
    /* الصندوق الخارجي */
...
def render_game_view(scenario):
    ...
    # كود SVG (تم تعديل الحدود للأحمر)
    svg = f"""
...
with st.sidebar:
    ...
    # القائمة المنسدلة (تم إصلاح ألوانها في CSS)
    ...
    if scenario == "Scenario B: VIP Convoy": 
        # منطق Scenario B: مخالفة Rule 1, Rule 2, Rule 6. (hE=1 لتمثيل "تبرير البروتوكول")
        d.update({"sH":1, "mH":1, "bEV":1, "hC":0, "vP":0, "hE":1, "hEA":0, "pMH":0}) 
        
    elif scenario == "Scenario C: Icy Road": 
        # منطق Scenario C: مسموح بسبب استثناء (pC=1)
